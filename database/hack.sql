...
-- Host: localhost    Database: hackacdemora
...
CREATE TABLE `users` (
  ...
  `number_found_flags` int NOT NULL DEFAULT '0',
...
CREATE TABLE `user_flags` (
  ...
  KEY `flag_id` (`flag_id`),
  CONSTRAINT `user_flags_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE,
  CONSTRAINT `user_flags_ibfk_2` FOREIGN KEY (`flag_id`) REFERENCES `flags` (`flag_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
